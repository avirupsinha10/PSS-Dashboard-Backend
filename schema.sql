...
ALTER TABLE ONLY public.users
    ADD CONSTRAINT unq_user UNIQUE (name);
...
INSERT INTO public.users (id,type,name,email) VALUES ('9e9427ac-5352-4b4d-a0ed-7edf9c7d8eb5','INTERNAL','Avirup Sinha','pss81official@gmail.com');
INSERT INTO public.users (id,type,name,email) VALUES ('5c8b180e-1b36-46a0-83c8-0a42ed1526ae','INTERNAL','Mainak Sinha','pss81official@gmail.com');
INSERT INTO public.users (id,type,name,email) VALUES ('68503a5f-0a65-458d-85f7-eb5554f003be','INTERNAL','Malay Sinha','pss81official@gmail.com');
...
INSERT INTO public.merchant (id,name,email,type,"bankId","userIds","siteIds","paymentAddress","esicPF","websiteLink") VALUES ('d72f3f63-b209-4216-baab-955042c3e46f','RUDRA AUTOMART','rudraautomart@rudrahyundai.in','F2','ad537875-d5bc-48b0-820c-560ee4dfd885','{}','{}','{"ushagram asansol-3"}','{}','rudraautomart.com');
